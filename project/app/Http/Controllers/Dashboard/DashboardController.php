...
class DashboardController extends Controller
{
    ...
    public function index_settings(Request $request)
    {
        ...
        $data['menus']['footer']        = ['icon' => 'bx bx-dock-bottom', 'title' => admin_lang('footer')];
        ...
        $data['settings']['general']['website'] = [
            ...
            'options'   => [
                ...
                ['type' => 'select', 'id' => 'language', 'name' => admin_lang('language'), 'value' => get_option('language', 'en'), 'options' => $this->get_languages(), 'class' => 'select2'],
        ...
        $data['settings']['general']['dashboard'] = [
            ...
            'options'   => [
                ...
                ['type' => 'select', 'id' => 'admin_language', 'name' => admin_lang('language'), 'value' => get_option('admin_language', 'en'), 'options' => $this->get_languages(), 'class' => 'select2'],
        ...
        $data['settings']['aboutme']['video'] = [
            ...
            'options'   => [
                ...
                ['type' => 'upload', 'id' => 'aboutme[video_url]', 'name' => admin_lang('url'), 'value' => $this->get_option('aboutme', 'video_url'), 'src' => 'src', 'library' => 'video'], 
            ]
        ];
        $data['settings']['aboutme']['services'] = [
            ...
            'options'   => [
                ...
                ['type' => 'radio', 'id' => 'aboutme[services_column]', 'name' => admin_lang('columns'), 'value' => $this->get_option('aboutme', 'services_column'), 'options' => [
        ...
        $data['settings']['portfolio']['portfolio'] = [
            ...
            'options'   => [
                ['type' => 'radio', 'id' => 'portfolio[sectiontitle]', 'name' => admin_lang('title'), 'value' => $this->get_option('portfolio', 'sectiontitle'), 'options' => [
                    '1' => admin_lang('on'),
                    '0' => admin_lang('off')
                ]],
                ...
                ['type' => 'radio', 'id' => 'portfolio[template]', 'name' => admin_lang('template'), 'value' => $this->get_option('portfolio', 'template'), 'options' => [
                    'full' => admin_lang('template').' 1',
                    'full2' => admin_lang('template').' 2',
                    'fix' => admin_lang('template').' 3',
                    'fix2' => admin_lang('template').' 4',
                ]],
                ['type' => 'radio', 'id' => 'portfolio[imagesize]', 'name' => admin_lang('image_size'), 'value' => $this->get_option('portfolio', 'imagesize'), 'options' => [
                    'full' => 'Full',
                    'thumbnail' => 'Thumbnail',
                    'medium' => 'Medium',
                    'large' => 'Large',
                ]],
                ['type' => 'radio', 'id' => 'portfolio[column]', 'name' => admin_lang('columns'), 'value' => $this->get_option('portfolio', 'column'), 'options' => [
                    'size-2' => ['img' => asset('images/options/2col.png')],
                    'size-3' => ['img' => asset('images/options/3col.png')],
                    'size-4' => ['img' => asset('images/options/4col.png')],
                    'size-5' => ['img' => asset('images/options/5col.png')],
                ]],
                ['type' => 'radio', 'id' => 'portfolio[layoutmode]', 'name' => admin_lang('layout_mode'), 'value' => $this->get_option('portfolio', 'layoutmode'), 'options' => [
                    'masonry' => 'Masonry',
                    'fitRows' => 'fitRows',
                ]],

                ['type' => 'radio', 'id' => 'portfolio[loadmore]', 'name' => admin_lang('load_more'), 'value' => $this->get_option('portfolio', 'loadmore'), 'options' => [
                    '1' => admin_lang('on'),
                    '0' => admin_lang('off')
                ]],
                ['type' => 'slider_number', 'id' => 'portfolio[limitloadmore]', 'name' => admin_lang('post_per_page'), 'value' => $this->get_option('portfolio', 'limitloadmore'), 'min' => '0', 'max' => '24', 'step' => '1'],
         ...
         * footer
         */
        $data['settings']['footer']['clients'] = [
            'title'     => admin_lang('clients'),
            'options'   => [
                ['type' => 'radio', 'id' => 'footer[clients_status]', 'name' => admin_lang('status'), 'value' => $this->get_option('footer', 'clients_status'), 'options' => [
                    '1' => admin_lang('on'),
                    '0' => admin_lang('off')
                ]],
                ['type' => 'html', 'html' => get_admin_view('settings.repeater.repeater_clients', ['clients' => $this->get_option('footer', 'clients'), 'input_name' => 'footer[clients]'])->render()],
            ]
        ];

        $data['settings']['footer']['footer'] = [
            'title'     => admin_lang('footer'),
            'options'   => [
                ['type' => 'radio', 'id' => 'footer[status]', 'name' => admin_lang('status'), 'value' => $this->get_option('footer', 'status'), 'options' => [
                    '1' => admin_lang('on'),
                    '0' => admin_lang('off')
                ]],
                ['type' => 'text', 'id' => 'footer[copyright]', 'name' => admin_lang('copyright'), 'value' => $this->get_option('footer', 'copyright')],
            ]
        ];
        $data['settings']['footer']['socials'] = [
            'title'     => admin_lang('socials'),
            'options'   => [
                ['type' => 'radio', 'id' => 'footer[socials_status]', 'name' => admin_lang('status'), 'value' => $this->get_option('footer', 'socials_status'), 'options' => [
                    '1' => admin_lang('on'),
                    '0' => admin_lang('off')
                ]],
                ['type' => 'html', 'html' => get_admin_view('settings.repeater.repeater_socials', ['socials' => $this->get_option('footer', 'socials'), 'input_name' => 'footer[socials]'])->render()],
            ]
        ];
        ...
        $data['settings']['style']['style'] = [
            ...
            'options'   => [
                ['type' => 'radio', 'id' => 'style[template]', 'name' => admin_lang('template'), 'value' => $this->get_option('style', 'template'), 'options' => [
                    ...
                    'scrollpage' => admin_lang('scroll_page'),
    ...
    public function get_languages(){
        $languages = DB::table(LANGUAGE_TABLE)->get();
        foreach($languages as $language){
            $lang[$language->code] = $language->name;
        }
