    ...
    <div class="section-pages clearfix">
        <div class="section-inner">
            <div class="section-title">
                <h3>{{$page_title}}</h3>
                <ul class="post-meta">
                    <li><i class="pe-7s-user"></i> {{get_username($single->post_author)}}</li>
                    <li><i class="pe-7s-date"></i> {{time_format($single->post_modified, 'date')}}</li>
                    <li><a href="{{url('blog/category/'.$term_slug)}}"><i class="pe-7s-notebook"></i> {{get_term_name($single->term_id)}}</a></li>
                    <li><i class="pe-7s-look"></i> {{$single->post_views}}</li>
                </ul>
