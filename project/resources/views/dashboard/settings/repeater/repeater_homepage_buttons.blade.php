    ...
    <div class="tacf-repeater">
        <table class="tacf-table">
            <tbody class="tacf-ui-sortable">
                @if(is_array($homepage_buttons) and count($homepage_buttons))
                    @php $key = 0; @endphp
                    @foreach($homepage_buttons as $item)
                    <tr class="tacf-row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="{{$input_name}}[{{$key}}][widget]" class="form-select form-select-100">
                                                <option value="0">{{admin_lang('none')}}</option>
                                                @foreach ($widgets as $widget_id => $widget_title)
                        ...
                        <div class="tacf-input tacf-toggle-content fadeIn">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>{{admin_lang('widgets')}}</label>
                                        <select data-name="{{$input_name}}[{key}][widget]" class="form-select  form-select-100 tacf-input-key">
                                            <option value="0">{{admin_lang('none')}}</option>
                                            @foreach ($widgets as $widget_id => $widget_title)
