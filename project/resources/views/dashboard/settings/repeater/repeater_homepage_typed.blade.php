    ...
    <div class="tacf-repeater">
        <table class="tacf-table">
            <tbody class="tacf-ui-sortable">
                @if(is_array($homepage_typed) and count($homepage_typed))
                    @php $key = 0; @endphp
                    @foreach($homepage_typed as $item)
                    <tr class="tacf-row">
                        <td class="tacf-field tacf-col-item">
                            <h3 class="tacf-head-item">
                                ...
                                @if(isset($item['toggle'])) <span class="tacf-collapse-button"><i class="fas fa-minus"></i></span> @else <span class="tacf-collapse-button"><i class="fas fa-plus"></i></span> @endif
                            ...
                            <div class="tacf-input tacf-toggle-content fadeIn @if(!isset($item['toggle'])) d-none @endif">
