                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" data-toggle="fileupload" data-field="boxsfooterclients-{{$key}}" data-src="true" data-size="full" type="text" name="{{$input_name}}[{{$key}}][image]" value="{{$item['image']}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="form-group">
                                            <label>{{admin_lang('image')}}</label>
                                            <input class="form-control tacf-input-key tacf-input-fileupload" data-field="boxsfooterclients-{key}" data-src="true" data-size="full" type="text" data-name="{{$input_name}}[{key}][image]">
                                        </div>
                                    </div>
                                </div>
                            </div>
