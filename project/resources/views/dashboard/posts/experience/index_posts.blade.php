            ...
            <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap">
                <thead>
                    <tr>
                        ...
                        <th class="hidden-phone text-center">{{admin_lang('duration')}}</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="hidden-phone text-center">
                            {{ get_post_meta('date_from', $post->id) }}<br />
                            @if(get_post_meta('icurrently', $post->id)){{admin_lang('icurrently_work')}}@else {{get_post_meta('date_to', $post->id)}}@endif
                        </td>
