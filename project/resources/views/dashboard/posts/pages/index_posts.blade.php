            ...
            <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap">
                <thead>
                    <tr>
                        ...
                        <th class="hidden-phone text-center">{{ admin_lang('views') }}</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="hidden-phone text-center">{{ $post->post_views }}</td>
                        <td class="hidden-phone text-center">{{ $post->post_modified }}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
